export const config = {
  ...
  lancedb: {
    uri: process.env.LANCEDB_URI || 's3://embeddings/',
  ...
  processing: {
    ...
    concurrency: {
      fileProcessing: parseInt(process.env.FILE_PROCESSING_CONCURRENCY || '2'),
      embedding: parseInt(process.env.EMBEDDING_CONCURRENCY || '5'),
      cleanup: parseInt(process.env.CLEANUP_CONCURRENCY || '1'),
    },
    supportedFormats: {
